...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, db_index=True, editable=False, primary_key=True, serialize=False, unique=True, verbose_name='ID')),
                ('hotel_id', models.ForeignKey(help_text='Hotel al que pertenece el tour en el horario seleccionado', on_delete=django.db.models.deletion.CASCADE, to='store.hotels', verbose_name='Hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Tour',
            fields=[
                ...
                ('date_start', models.DateField(default=datetime.datetime(2022, 12, 15, 15, 26, 21, 42399), help_text='Fecha de inicio del tour', verbose_name='Fecha de inicio')),
                ('date_end', models.DateField(default=datetime.datetime(2022, 12, 15, 15, 26, 21, 42399), help_text='Fecha de fin del tour', verbose_name='Fecha de fin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, db_index=True, editable=False, primary_key=True, serialize=False, unique=True, verbose_name='ID')),
                ('time_start', models.TimeField(default=datetime.datetime(2022, 12, 15, 15, 26, 21, 175398), help_text='Hora de inicio del tour', verbose_name='Hora de inicio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 12, 15, 15, 26, 21, 177404), help_text='Fecha del tour', verbose_name='Fecha')),
                ('id_pick_up', models.ForeignKey(help_text='Tour seleccionado con horario, hotel y pick up', on_delete=django.db.models.deletion.CASCADE, to='store.pickups', verbose_name='Tour Pick Up')),
            ],
        ),
        migrations.AddField(
            model_name='pickups',
            name='tour_time_id',
            field=models.ForeignKey(help_text='Tour seleccionado con horario', on_delete=django.db.models.deletion.CASCADE, to='store.tourstimes', verbose_name='Tour Horario'),
        ),
    ]
