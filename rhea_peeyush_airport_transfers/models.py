...
class Transport(models.Model):
    key = models.CharField(
        ...
        verbose_name='Clave',
        db_index=True,
        help_text='Clave del transporte',
        default='',
        unique=True
    )
    name = models.CharField(
        ...
        verbose_name='Nombre',
        db_index=True,
        help_text='Nombre del transporte',
        default='',
        unique=True
    )
    price = models.FloatField(
        verbose_name='Precio',
        help_text='Precio del transporte',
        default=0.0
    )
    by_default = models.BooleanField(
        verbose_name='Por defecto',
        help_text='Transporte por defecto',
        default=False
    )
...
class FreeDays(models.Model):
    ...
    category = models.ForeignKey(
        ...
        db_index=True,
        help_text='Categoría de día gratis',
