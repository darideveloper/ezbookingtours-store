...
class Sale(models.Model):
    ...
    arriving_airline = models.CharField(
        max_length=255, verbose_name="Aerolínea de llegada"
    )
    arriving_flight = models.CharField(max_length=255, verbose_name="Vuelo de llegada")
    ...
    departing_airline = models.CharField(
        max_length=255, verbose_name="Aerolínea de salida"
    )
    departing_flight = models.CharField(max_length=255, verbose_name="Vuelo de salida")
